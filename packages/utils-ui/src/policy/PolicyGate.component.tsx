...
import type { PolicyGateProps } from './PolicyGate.types';
                  ...
                  <div className={styles.meta}>
                    <div className={styles.info}>
                      <div>
                        ...
                        {policy?.effective_date ? <div className={styles.date}>Effective: {new Date(policy.effective_date).toLocaleDateString()}</div> : null}
